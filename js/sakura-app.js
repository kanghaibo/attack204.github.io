...
function nextBG() {
    $(".centerbg").css("background-image", 'url("https://cdn.jsdelivr.net/gh/honjun/cdn@1.6/img/cover/(' + Math.abs(bgn%8) + ').jpg.webp")');
    bgn = bgn + 1;
}
...
$(document).ready(function () {
    $(".centerbg").css("background-image", 'url("https://cdn.jsdelivr.net/gh/honjun/cdn@1.6/img/cover/(' + bgn + ').jpg.webp")');
